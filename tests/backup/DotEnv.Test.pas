...
begin
  ...
  CheckFalse(FEnv.GetBool('FLAG'), 'Invalid bool string is false');
  CheckTrue(FEnv.GetBool('FLAG', True), 'But we should use default... wait');
  // Actually invalid should return false, not default. Let's verify behavior
end;
